...
namespace ros2
{
      ...
      public:
            ...
            static void convertToPointXYZTIRRRA(const sensor_msgs::msg::PointCloud2 &pc2, pcl::PointCloud<pcl::PointXYZTIRRRA> &pcl);

            static void toPCL(const sensor_msgs::msg::PointCloud2::SharedPtr pc2, pcl::PointCloud<pcl::PointXYZ> &pcl);
            static void toPCL(const sensor_msgs::msg::PointCloud2::SharedPtr pc2, pcl::PointCloud<pcl::PointXYZIR> &pcl);
            static void toPCL(const sensor_msgs::msg::PointCloud2 &pc2, pcl::PointCloud<pcl::PointXYZTIRRRA> &pcl);
            ...
            static void toPointCloud2(const pcl::PointCloud<pcl::PointXYZTIRRRA> &cloud, sensor_msgs::msg::PointCloud2 &cloud_out);
            ...
            static void toROSMsg(const pcl::PointCloud<pcl::PointXYZ> &cloud, sensor_msgs::msg::PointCloud2 &cloud_out);
            static void toROSMsg(const pcl::PointCloud<pcl::PointXYZIR> &cloud, sensor_msgs::msg::PointCloud2 &cloud_out);
            static void toROSMsg(const pcl::PointCloud<pcl::PointXYZTIRRRA> &cloud, sensor_msgs::msg::PointCloud2 &cloud_out);
            ...
            template<class T>
            static bool isNan(const T &point)
            {
